...
<body class="bg-light">
    <div class="container mt-5">
        <h1 class="text-center text-success mb-4">Agregar Paciente</h1>
            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="direccion" id="direccion" class="form-control" rows="3" placeholder="Dirección"></textarea>
                    </div>
